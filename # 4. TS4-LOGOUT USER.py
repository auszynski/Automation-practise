...
insertValue('login-email','automationtester4@test.com')       #input e-mail adress e.g automationtester4@test.com
time.sleep(1)
...
loginpage = driver.find_element(By.CSS_SELECTOR,'#form > div > div > div.col-sm-4.col-sm-offset-1 > div > h2')
if loginpage.is_displayed():
